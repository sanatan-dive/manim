...
const Works: React.FC = () => {
  ...
  const steps: Step[] = [
    { title: "Prompt", step: "1", description: "Enter your mathematical concept or question to start the process." },
    { title: "Analyze", step: "2", description: "Gemini processes your prompt to understand and structure the query." },
    { title: "Generate", step: "3", description: "Manim Python code is created to visualize your concept." },
    { title: "Animate", step: "4", description: "Watch the mathematical animation come to life." },
  ]
        ...
        >
          ...
          <motion.div variants={fadeIn(0.6)} className='flex-1 max-w-2xl'>
            <h2 className='text-xl font-funnel leading-relaxed mt-8'>
              Our platform transforms your mathematical ideas into stunning animations. Enter a prompt, let Gemini analyze it, generate Manim Python code, and watch your concept come to life as an engaging visualization.
            </h2>
          </motion.div>
          ...
          <motion.div variants={fadeIn(0.8)} className='flex items-center gap-6 mr-21 '>
            ...
            <button className="group relative overflow-hidden">
              <div className="flex items-center px-6 py-3 rounded-full bg-gray-100  backdrop-blur-sm border border-white hover:bg-black/5 active:scale-95 transition-all duration-300 ease-out relative">
                ...
                <PlayCircle
                  className="w-8 h-8 mr-3 text-black group-hover:text-black group-hover:scale-105 transition-all duration-300 ease-out relative z-10"
                />
        ...
        >
          {steps.map((item, index) => (
            ...
            >
              ...
              >
                <span className="text-2xl font-bold font-funnel text-black">{item.step}</span>
              </div>
              <h3 className="text-lg font-bold italic text-black font-funnel mt-4">{item.title}</h3>
            </motion.div>
          ))}
        </motion.div>
